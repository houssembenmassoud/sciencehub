...
/**
 * Precompiled java-common-conventions script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class JavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_JavaCommonConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.bakdata.mockito");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_JavaCommonConventions").asSubclass(BasicScript.class);
